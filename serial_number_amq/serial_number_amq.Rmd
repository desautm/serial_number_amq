...
Pour la lectrice ou le lecteur intéressé, vous trouverez ci-dessous le code `R` complet qui a servi à produire les diverses figures de cet article.
