...
N4(ech)
```
Nous simulons 5 000 échantillons de taille 5 à partir d'une population de taille 500. Nous calculons pour chacun de ces échantillons nos quatre estimés. La figure \ref{fig:ech-taille-5} représente ces échantillons.

```{r ech-taille-5, echo = FALSE, fig.cap="Représentation sous forme d'histogrammes de 5 000 échantillons de taille 5, pour les quatres estimateurs", out.width="90%"}
N <- 500
n <- 5
iter <- 5000
pop <- c(1:N)
