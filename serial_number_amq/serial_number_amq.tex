...
HEAD Le problème du char d'assaut allemand est nommé d'après son
application par les Alliés à l'estimation du nombre de chars d'assaut
produits par l'Allemagne. Mais en fait, ce problème regroupe
l'estimation du nombre de divers produits de guerre allemands, comme par
exemple les camions, les fusils, les bombes et les fusées
\cite{Ruggles1947}. En particulier, nous présentons au
tableau~\ref{tab:estimation_ruggles} les estimations du nombre de chars
d'assaut allemands en comparaison avec l'estimation par les services de
renseignements et les archives allemandes, tel que présenté dans
\cite{Ruggles1947}. Comme vous pouvez le constater, les estimations
statistiques étaient beaucoup plus précises que les estimations
provenant des services de renseignements. ======= Le problème du char
d'assaut allemand est nommé d'après son application par les Alliés à
l'estimation du nombre de chars d'assaut produits par l'Allemagne. Mais
en fait, ce problème regroupe l'estimation du nombre de divers produits
de guerre allemands, comme par exemple les camions, les fusils, les
bombes et les fusées, voir \cite{Ruggles1947}. En particulier, nous
présentons au tableau\ref{tab:estimation_ruggles} les estimations du
nombre de chars d'assaut allemands en comparaison avec l'estimation par
les services de renseignements et les archives allemandes, tel que
