...
\cite{Roberts1967}. Davantage d'information est par contre disponible en
\cite{Hohle2006} et en \cite{WikiGermanTank}. Il est intéressant de voir
les différences entres les estimations trouvées dans cet article et les
estimations trouvées dans un contexte bayésien.
