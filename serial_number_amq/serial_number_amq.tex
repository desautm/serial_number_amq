...
Dans cette section, nous allons trouver divers estimateurs. Nous
cherchons l'estimateur de variance minimale.
...
Pour les simulations qui suivront à la section \ref{simul}, nous
n'utiliserons pas ces deux nouveaux estimateurs, car l'étude statistique
théorique de ces deux estimateurs est plus complexe. Nous invitons par
contre la lectrice et le lecteur intéressé à modifier le code que vous
trouverez à l'annexe \ref{code} pour étudier ces estimateurs.
...
convergents, c'est-à-dire qu'ils convergent vers la vraie valeur de la
taille de la population.

Puisque l'espérance des cinq estimateurs convergent vers la taille de la
population, ceux-ci sont tous non biaisés. Par contre, l'estimateur
\(\widehat{N_4}\) est l'estimateur à variance minimale car sa variance
est plus petite que celle de tous les autres.
